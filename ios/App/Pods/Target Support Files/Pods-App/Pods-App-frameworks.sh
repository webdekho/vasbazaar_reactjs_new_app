...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AalzehlaCapacitorSmsRetriever/AalzehlaCapacitorSmsRetriever.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityContacts/CapacitorCommunityContacts.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CapacitorCommunityNativeAudio/CapacitorCommunityNativeAudio.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CapawesomeTeamCapacitorFileOpener/CapawesomeTeamCapacitorFileOpener.framework"
