...
export const buildQrStickerWindowHtml = ({ qrImg }) => {
    ...
    <body>
      <div class="vb-sticker">
        ...
        <div class="vb-content">
          <div class="vb-header">
            <img class="vb-logo" src="https://webdekho.in/images/vasbazaar1.png" alt="VasBazaar" />
          </div>
          <div>
          ...
          <div class="vb-qr-shell">
            <div class="vb-qr-frame">
              ...
              <img class="vb-qr-image" src="${escapeHtml(qrImg)}" alt="QR Code" />
            </div>
...
export const openQrStickerWindow = (mobile, size = 360) => {
  ...
  qrWin.document.write(buildQrStickerWindowHtml({ qrImg }));
